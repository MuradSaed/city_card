<template>
  <div class="content">
    <div class="echarts-panel" >
      <div class="pie-title">交易总面积</div>
      <img class="img" src="img/panel/line.png" />
      <div class="farm-land" ref="farmLand"></div>
    </div>
    <div class="echarts-panel">
      <div class="pie-title">数据统计截止9月19日</div>
      <img class="img" src="img/panel/line.png" />
      <div class="plowland">
        <div>
          <div class="dkzs">
            <img src="img/panel/icon-dkzs.png" />
            <div class="dkzs-text">流转交易</div>
          </div>
          <div class="dkzs-label">98笔</div>
        </div>
        <div>
          <div class="lzmj">
            <img src="img/panel/icon-lzmj.png" />
            <div class="lzmj-text">交易面积</div>
          </div>
          <div class="lzmj-label">10.33万亩</div>
        </div>
        <div>
          <div class="httj">
            <img src="img/panel/icon-httj.png" />
            <div class="httj-text">成交总价</div>
          </div>
          <div class="httj-label">0.44亿元</div>
        </div>
        <div>
          <div class="qqrs" >
            <img src="img/panel/zichan.png" />
            <div class="qqrs-text">溢价率</div>
          </div>
          <div class="qqrs-label">32.75%</div>
        </div>

        <div>
          <div class="qqrs" style="filter: hue-rotate(180deg)">
            <img src="img/panel/zhangdan.png" />
            <div class="qqrs-text">资产出租</div>
          </div>
          <div class="qqrs-label" style="filter: hue-rotate(180deg)">9笔</div>
        </div>
        <div>
          <div class="qqrs" style="filter: hue-rotate(90deg)">
            <img src="img/panel/jiazhi.png" />
            <div class="qqrs-text">出租总价</div>
          </div>
          <div class="qqrs-label" style="filter: hue-rotate(90deg)">112万元</div>
        </div>
      </div>

    </div>
    <div class="echarts-panel">
      <div class="pie-title">总计</div>
      <img class="img" src="img/panel/line.png" />
      <div class="plant">
        <div>
          <div class="farm-num">
        ...
        <div>
          <div class="organic-num" style="filter: hue-rotate(90deg)">
            <div class="plant-echart-1" ref="plantEchart4"></div>
          </div>
          <div>
            <div>整体溢价率</div>
          </div>
...
export default {
  ...
  methods: {
    ...
    plantInitEcharts4() {
      const myEcharts = echarts.init(this.$refs.plantEchart4);
      let option = {
        series: [
          {
            type: "gauge",
