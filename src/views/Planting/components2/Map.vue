  ...
  <div>
    ...
    <div class="cqlbox">
      ...
      <div class="flex_start alicenter cqlitem" @click="cqlwms" data-cql="小麦">
        <div class="cqlcolor" style="background-color: #ffaa00;"></div>
        <div>过旺</div>
      </div>

      <div class="flex_start alicenter cqlitem" @click="cqlwms" data-cql="玉米">
        <div class="cqlcolor" style="background-color: #5bd887;"></div>
        <div>过盛</div>
      </div>
      
      <div class="flex_start alicenter cqlitem" @click="cqlwms" data-cql="玉米">
        <div class="cqlcolor" style="background-color: #00fff4;"></div>
        <div>正常</div>
      </div>

      <div class="flex_start alicenter cqlitem" @click="cqlwms" data-cql="玉米">
        <div class="cqlcolor" style="background-color: #4ad2ff;"></div>
        <div>较差</div>
      </div>
      <div class="flex_start alicenter cqlitem" @click="cqlwms" data-cql="玉米">
        <div class="cqlcolor" style="background-color: #248ae0;"></div>
        <div>极差</div>
      </div>
...
watch(
  ...
  () => {
    nextTick(() => {
      console.log(1122)
      // data.map.flyTo([props.lat, props.lng], 14);
...
let polygonPane = data.map.createPane('polygonPane');
  ...
  //   let customIconMarker = L.marker([data.aredList[i].lat, data.aredList[i].lnt], { icon: myIcon }).addTo(data.map);
